...
<head>
    ...
    <title>Login Page - {{ $setting->company_name ?? '' }}</title>
          ...
          <div class="auth-wrapper auth-v2">
            <div class="auth-inner row m-0">
              <a class="brand-logo" href="javascript:void(0);">
                <svg viewBox="0 0 139 95" style="transform: rotate(180deg)" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="28">
                  <defs>
                ...
                <h2 class="brand-text text-primary ml-1" style="margin-top: 5px;">{{ $setting->company_name ?? '' }}</h2></a>
              <!-- /Brand logo-->
              <!-- Left Text-->
              ...
              <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                  <h2 class="card-title font-weight-bold mb-1">Welcome {{ $setting->company_name ?? ''}} 👋</h2>
                  ...
                  <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" id="login-email" type="text" name="email" value="{{ old('email') }}" autocomplete="off" placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1"/>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-merge form-password-toggle">
                        <input class="form-control form-control-merge" id="login-password" type="password" autocomplete="off" name="password" placeholder="············" aria-describedby="login-password" tabindex="2"/>
